      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Book new tests and view your diagnostic results.
          </p>
        </div>
            ...
            <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-900 flex justify-between items-start">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Requested by Dr. Jenkins • Oct 22
                </p>
              </div>
              <span className="px-2 py-1 text-[10px] font-bold uppercase rounded bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300">
                Awaiting Sample
              </span>
            </div>
          </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    Sep 15, 2023 • City Center Lab
                  </p>
                </div>
              </div>
              <div className="text-right flex items-center gap-3">
                <span className="hidden sm:inline-block text-xs font-medium text-green-600 dark:text-green-400">
                  Normal Range
                </span>
