...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMsg('If an account exists with that email, a recovery link has been sent.');
      setEmail('');
    } catch (_err: unknown) {
       console.error(_err);
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-background dark:bg-slate-950 text-slate-500">Or</span>
                </div>
              </div>
